...
const navigateAndSelectProduct = (key) => {
  if (key === "ArrowDown") {
    ...
    resultContainerTag.textContent = "";
    const noteForEnter = document.createElement("div");
    noteForEnter.classList.add("noteForEnter")
    // const noteForEnterTag = document.getElementsByClassName("noteForEnter")[0];
    // noteForEnterTag.style.textAlign = "center";
    // noteForEnterTag.style.color="skyBlue";
    noteForEnter.append("You have selected!!");
    resultContainerTag.append(noteForEnter,enterProduct)
  }
};
...
const selectProduct = (index) => {
  ...
  productItemContainerToSelect.style.backgroundColor = "skyBlue";
